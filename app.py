...
if prompt := st.chat_input("What would you like to chat about?"):
    ...
    with st.chat_message("assistant"):
        ...
        if obnoxious_prompt:
            ...
            # Extract only the ML-relevant portion, with conversation history for follow-up resolution
            extract_messages = [
                {"role": "system", "content": "Extract only the machine learning or AI related question from the user's input. Machine learning topics include: decision trees, neural networks, perceptrons, gradient descent, SVMs, kernel methods, bias-variance tradeoff, unsupervised learning, clustering, classification, regression, ensemble methods, and similar topics. If the user's message is a follow-up (e.g. 'tell me more', 'explain further') use the conversation history to determine the ML topic being discussed and return a full standalone ML question. If there is absolutely no ML-related question, return 'NONE'."},
